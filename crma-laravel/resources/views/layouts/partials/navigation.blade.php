    ...
    <div class="yoo-main-header">
      <div class="yoo-main-header-in">
        <div class="yoo-main-header-left">
          <a href="index.html" class="yoo-logo-link yoo-light-logo"><img src="{{ asset("images/ENL-logo.png") }}" alt="logo-light" /></a>
          <!-- For Site Title -->
        ...
        <ul class="yoo-sidebar-nav-list yoo-mp0">
          ...
          <li class="active">
            <a href="{{ route("crews.index") }}">
              <span class="yoo-sidebar-link-title">
                <span class="yoo-sidebar-link-icon yoo-style1"><ion-icon name="people"></ion-icon></span>
                <span class="yoo-sidebar-link-text">Crews</span>
              </span>
            </a>
          </li>
          <li>
            <a href="#">
              <span class="yoo-sidebar-link-title">
                <span class="yoo-sidebar-link-icon yoo-style1"><ion-icon name="boat"></ion-icon></span>
                <span class="yoo-sidebar-link-text">Vessels</span>
              </span>
            </a>
          </li>
          <li>
            <a href="#">
              <span class="yoo-sidebar-link-title">
                <span class="yoo-sidebar-link-icon yoo-style1"><ion-icon name="contract"></ion-icon></span>
                <span class="yoo-sidebar-link-text">Contract</span>
              </span>
            </a>
          </li>
          <li>
            <a href="#">
              <span class="yoo-sidebar-link-title">
                <span class="yoo-sidebar-link-icon yoo-style1"><ion-icon name="card"></ion-icon></span>
                <span class="yoo-sidebar-link-text">Payroll</span>
              </span>
            </a>
          </li>
