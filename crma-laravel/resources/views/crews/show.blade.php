    ...
    <div class="row mb-3">
        <div class="col-md-9">
            ...
            <div class="form-group">
                ...
                <input name="gender" id="gender" class="form-control" type="text" value="{{ $crew->gender->gender }}" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <p>Create:{{ $medical_record->release_at }}</p>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope="col">{{ $licence->licence->name }}</th>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope="col">{{ $certificate->certificate->name }}</th>
            ...
            <div class="row">
                ...
                <div class="col-md">
                    ...
                    <div class="form-group">
                        ...
                        <input name="bank[bank_code]" id="bank_bank_code" class="form-control" type="text" value="{{ $crew->bank_account->bank->name }}" readonly>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="province" id="province" class="form-control" value="{{ $crew->province->name }}" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label for="regency">Regency</label>
                    <input type="text" name="regency" id="regency" class="form-control" value="{{ $crew->regency->name }}" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label for="district">District</label>
                    <input type="text" name="district" id="district" class="form-control" value="{{ $crew->district->name }}" readonly>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="village">Village</label>
                    <input type="text" name="village" id="village" class="form-control" value="{{ $crew->village->name }}" readonly>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="religion" id="religion" class="form-control" value="{{ $crew->religion->name }}" readonly>
                </div>
                <div class="form-group col-md-6">
