        ...
        <div class="row mt-3 mb-5">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <input name="birthplace" id="birthplace" class="form-control" type="text" placeholder="Ex: Denpasar, Bali" value="North Pacific Ocean" required>
